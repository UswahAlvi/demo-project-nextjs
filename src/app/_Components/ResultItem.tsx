...
export default function ResultItemComponent({item}:{item: Item}){
    ...
    return(
        <div className="group flex p-[12px] pe-[20px] justify-between gap-[20px] rounded-xs hover:bg-(--color-gray)">
            ...
            <div className="flex flex-col w-87 ">
                <span className="text-[20px] font-medium pt-[12px]"> {item.title} </span>
                <span className="text-[16px] font-normal text-(--paragraph) whitespace-nowrap overflow-hidden text-ellipsis"> {item.description} </span>
            </div>
